<div class="row row-body p-lg-5 p-3">
    ...
    <!-- start -->
        ...
        <?php
            ...
            if($res_contracts):
                foreach($res_contracts as $key =>$val):
        ?>
                    <div class="row d-flex row-project mb-1 p-3 pr-0 rounded">
                        ...
                        <div class="col-5 col-lg-4 col-xl-3 pt-2"><b><?= strtoupper($val['date_contrat']) ?></b></div>
                        <div class="col-1 d-flex justify-content-end"><a href="?page=MyContract&contrat=<?= $val['lien'] ?>"><button class="btn"><i class="fas fa-download"></i></button></a></div>
                    </div>
        <?php
                endforeach;
            endif;
